package com.mjcwrks.gpuimagefilter;
...
import com.mjcwrks.gpuimagefilter.filter.GPUImage;
import com.mjcwrks.gpuimagefilter.filter.GPUImageToneCurveFilter;
import com.mjcwrks.gpuimagefilter.filter.GPUImageView;
import com.mjcwrks.gpuimagefilter.filter.ImageAdapter;
import com.mjcwrks.gpuimagefilter.filter.TwoWayAdapterView;
import com.mjcwrks.gpuimagefilter.filter.TwoWayGridView;
...
public class FilterActivity extends AppCompatActivity {
    ...
    private void initGrid() {
        mPackGrid.setAdapter(new ImageAdapter(this, mPackIds));
        ...
        mPackGrid.setOnItemClickListener(new TwoWayAdapterView.OnItemClickListener() {
            ...
            public void onItemClick(TwoWayAdapterView<?> parent, View view, int i, long id) {
                ...
                if (i == 0) {
                    ...
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack1));
                } else if (i == 1) {
                    mSelectedPack = mFilterPack2;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack2));
                } else if (i == 2) {
                    mSelectedPack = mFilterPack3;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack3));
                } else if (i == 3) {
                    mSelectedPack = mFilterPack4;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack4));
                } else if (i == 4) {
                    mSelectedPack = mFilterPack5;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack5));
                } else if (i == 5) {
                    mSelectedPack = mFilterPack6;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack6));
                } else if (i == 6) {
                    mSelectedPack = mFilterPack7;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack7));
                } else if (i == 7) {
                    mSelectedPack = mFilterPack8;
                    mImageGrid.setAdapter(new ImageAdapter(FilterActivity.this, mThumbIdsPack8));
                }
                TwoWayGridView twoWayGridView = mPackGrid;
                twoWayGridView.setVisibility(View.GONE);
                twoWayGridView = mImageGrid;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done) {
            ...
            if(Build.VERSION.SDK_INT >= Q){
                str2 = Environment.DIRECTORY_PICTURES+"/"+".tempedit";
            }
