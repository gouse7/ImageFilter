...
Java_com_mjcwrks_gpuimagefilter_filter_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env, jobject obj,
                                                                       jbyteArray yuv420sp,
...
JNIEXPORT void JNICALL
Java_com_mjcwrks_gpuimagefilter_filter_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env, jobject obj,
                                                                       jbyteArray yuv420sp,
                                                                       jint width, jint height,
                                                                       jintArray rgbOut) {
    int sz;
...
JNIEXPORT void JNICALL
Java_com_mjcwrks_gpuimagefilter_filter_GPUImageNativeLibrary_adjustBitmap(JNIEnv *jenv, jclass thiz,
                                                                       jobject src) {
